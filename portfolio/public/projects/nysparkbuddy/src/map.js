...
const accessToken = "pk.eyJ1IjoicmVhbGJjb2xlIiwiYSI6ImNsZzVtMzB6bjAyZWYzZGxxNG5qdmZneTQifQ.FsAnAvtZ-bqvuc2g5r12qA";
let map;

// An example of how GeoJSON is formatted
...
const addMarker = (feature, className, clickHandler) => {
	// Create map marker using feature data
	...
	// Call method when marker is clicked
